...
ExportScript.ConfigArguments =
{
    ...
    [123] = "%.2f",  -- Pilot_UHF_Communication_Channel_Control_Knob {-0.058823529, 0, 1, Set Comm Channel}
    ...
    [136] = "%.2f",  -- Pilot_UHF_AUX_Channel_Control_Knob {-0.052631579, 0, 1, Set AUX Channel}
    ...
    [640] = "%.4f",  -- Pilot_TACAN_Chan_Ones_Knob {-0.1, 0, 0.9 Set TACAN Channel (ones)}
    ...
    [646] = "%.2f",  -- Pilot_TACAN_Mode_Knob {-0.25, 0, 1, Select TACAN Mode}
    ...
    [1374] = "%1d",  -- Pilot_UHF_Squelch {-1, 0, 1, UHF Squelch Switch}
    [1375] = "%.4f", -- Pilot_UHF_Freq_Hundreds {-0.333333333, 0, 1, Set Frequency (hundreds)}
    [1376] = "%1d",  -- Pilot_UHF_Freq_Mode {-1, 0, 1, Select Frequency Mode}
    ...
    [1515] = "%.2f", -- Pilot_VOR_Freq_decimal {-0.05001, 0, 0.95 Set ILS Frequency (decimals)}
