...
ExportScript.ConfigArguments =
{
	...
	-- AN/ARC-210
    [534] = "%.2f",
    [551] = "%.1f",    -- master select
    [552] = "%.2f",    -- channel
    [553] = "%.1f",    -- second select
    [554] = "%.1f",    -- freq 100MHz
    [555] = "%.1f",    -- freq 10MHz
    [556] = "%.1f",    -- freq 1MHz
    [557] = "%.1f",    -- freq 100KHz
	...
	[137] = "%0.2f",   -- PTR-ANARC186-VHFAM-PRESET (Preset Channel Selector)
	...
	[151] = "%0.2f",   -- PTR-ANARC186-VHFFM-PRESET (Preset Channel Selector)
	...
	-- Inercom Panel
	[221] = "%.1f",    -- PTR-INTERCOM-INT (INT Switch)
	[222] = "%1d",     -- PTR-INTERCOM-INT (INT Switch)
	[223] = "%.1f",    -- PTR-INTERCOM-FM (FM Switch)
	[224] = "%1d",     -- PTR-INTERCOM-FM (FM Switch)
	[225] = "%.1f",    -- PTR-INTERCOM-VHF (VHF Switch)
	[226] = "%1d",     -- PTR-INTERCOM-VHF (VHF Switch)
	[227] = "%.1f",    -- PTR-INTERCOM-UHF (UHF Switch)
	[228] = "%1d",     -- PTR-INTERCOM-UHF (UHF Switch)
	[229] = "%.1f",    -- PTR-INTERCOM-AIM (AIM Switch)
	[230] = "%1d",     -- PTR-INTERCOM-AIM (AIM Switch)
	[231] = "%.1f",    -- PTR-INTERCOM-IFF (IFF Switch)
	[232] = "%1d",     -- PTR-INTERCOM-IFF (IFF Switch)
	[233] = "%.1f",    -- PTR-INTERCOM-ILS (ILS Switch)
	[234] = "%1d",     -- PTR-INTERCOM-ILS (ILS Switch)
	[235] = "%.1f",    -- PTR-INTERCOM-TCN (TCN Switch)
	[236] = "%1d",     -- PTR-INTERCOM-TCN (TCN Switch)
	[237] = "%1d",     -- PTR-INTERCOM-HM (HM Switch)
	[238] = "%.1f",    -- PTR-INTERCOM-VOL (Intercom volume)
	[239] = "%.1f",   -- PTR-INTERCOM-MODE (Selector switch)
	...
	[359] = "%.1f",    -- PNT-LEV-CMSP-BRT (Adjust Display Brightness)
	[360] = "%1d",     -- PNT-TMB-CMSP-MWS (Missile Warning System (MWS). Left mouse - ON/OFF, Right mouse - MENU (No Function))
	[361] = "%1d",     -- PNT-TMB-CMSP-JMR (Electronic Countermeasure Jammer (JMR). Left mouse - ON/OFF, Right mouse - MENU (No Function))
	[362] = "%1d",     -- PNT-TMB-CMSP-RWR (Radar Warning Receiver (RWR). Left mouse - ON/OFF, Right mouse - MENU)
	[363] = "%1d",     -- PNT-TMB-CMSP-DISP (Countermeasure Dispenser (DISP). Left mouse - ON/OFF, Right mouse - MENU)
	[364] = "%.1f",     -- PNT-LEV-CMSP-MODE (Master CMS Mode Select)
	-- CMSC
	[365] = "%.1f",    -- PNT-BTN-RWR-JMR (Select Jammer Program)
	[366] = "%.1f",    -- PNT-BTN-RWR-MWS (Cycle Missile Warning System Programs. No function)
	[367] = "%.1f",    -- PNT-LEV-RWR-BRT (Adjust Display Brightness)
	[368] = "%.1f",    -- PNT-LEV-RWR-AUD (Adjust RWR Volume)
