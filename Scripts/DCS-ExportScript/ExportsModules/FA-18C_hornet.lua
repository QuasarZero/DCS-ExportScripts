...
ExportScript.ConfigArguments = 
{
	...
	[145] = "%.1f",   -- HUD Balance Control Knob {0.0,1.0} in 0.1 Steps
	[146] = "%.1f",   -- HUD AOA Indexer Control Knob {0.0,1.0} in 0.1 Steps
	...
	[174] = "%.1f",   -- IFEI Brightness Control Knob {0.0,1.0} in 0.1 Steps
	-- Sensor panel
	...
	-- intercom
	[357] = "%.1f",   -- VOX Volume Control Knob {0.0,1.0} in 0.1 Steps
	[358] = "%.1f",   -- ICS Volume Control Knob {0.0,1.0} in 0.1 Steps
	[359] = "%.1f",   -- RWR Volume Control Knob {0.0,1.0} in 0.1 Steps
	[360] = "%.1f",   -- WPN Volume Control Knob {0.0,1.0} in 0.1 Steps
	[361] = "%.1f",   -- MIDS B Volume Control Knob {0.0,1.0} in 0.1 Steps
	[362] = "%.1f",   -- MIDS A Volume Control Knob {0.0,1.0} in 0.1 Steps
	[363] = "%.1f",   -- TACAN Volume Control Knob {0.0,1.0} in 0.1 Steps
	[364] = "%.1f",   -- AUX Volume Control Knob {0.0,1.0} in 0.1 Steps
	...
	[445] = "%.1f",   -- KY-58 Volume Control Knob {0.0,1.0} in 0.1 Steps
	...
	[263] = "%.1f",   -- ALR-67 DMR Control Knob {0.0,1.0} in 0.1 Steps
	[262] = "%.1f",   -- ALR-67 AUDIO Control Knob (no function){0.0,1.0} in 0.1 Steps
	[261] = "%.1f",   -- ALR-67 DIS TYPE Switch, N/I/A/U/F {0.0,0.1,0.2,0.3,0.4}
	[216] = "%.1f",   -- ALR-67 RWR Intensity Knob {0.0,1.0} in 0.1 Steps
	-- CMDS
