...
ExportScript.ConfigEveryFrameArguments = 
{
	...
	[504] = "%.1f",  -- Landing Gear Indicator Light Knob, MIN..MAX {0..1} (0=0, 0.25=90, 0.5=180, 0.75=270)
	[532] = "%1d",   -- Yaw Trim Switch, LEFT/CENTER/RIGHT {-1,0,1}
	[538] = "%1d",   -- Flare Dispense Button, OUT/IN {0,1}
	--- Radio Panel ---
	[545] = "%.1f",  -- Radio Volume Knob, MIN..MAX {0..1}
	...
	[728] = "%.1f",  -- HUD Contrast Knob, MIN..MAX {0..1}
	[729] = "%.1f",  -- HUD Brightness Knob, MIN..MAX {0..1}
	[730] = "%1d",   -- UFCP +/- Momentary Switch {1,0,-1}
	[731] = "%.1f",  -- HUD Backup Reticle Knob, MIN..MAX {0..1}
	[732] = "%.1f",  -- UFCP Brightness Knob, MIN..MAX {0..1}
	--- MFCD ---
	...
	[901] = "%.1f",  -- Warning Panel Brightness Knob, MIN..MAX {0..1}
	[903] = "%.1f",  -- Oxygen Indicator Brightness Knob, MIN..MAX {0..1}
	[909] = "%.1f",  -- AAP Brightness Knob, MIN..MAX {0..1}
	[934] = "%.1f",  -- COM1 Volume Knob, MIN..MAX {0..1}
	[938] = "%.1f",  -- COM2 Volume Knob, MIN..MAX {0..1}
	[939] = "%.1f",  -- TCN/ILS Volume Knob, MIN..MAX {0..1}
	[940] = "%.1f",  -- MSL Volume Knob, MIN..MAX {0..1}
	[941] = "%.2f",  -- Air Temp Knob Selector, MIN..MAX {0..0.91666666666667}
	[944] = "%.1f",  -- Inst. Light Knob, MIN..MAX {0..1}
	[945] = "%.1f",  -- Console Light Knob, MIN..MAX {0..1}
	[946] = "%.1f",  -- Flood Light Knob, MIN..MAX {0..1}
	[959] = "%.2f",  -- Canopy Manual Open/Close Crank, MIN..MAX {0..1}
	[964] = "%.1f",  -- AAR Light Brightness Knob, MIN..MAX {0..1}
	[965] = "%.1f",  -- Right Forward Flood Light Direction, MIN..MAX {0..1}
	[966] = "%.1f",  -- Right Aft Light Direction, MIN..MAX {0..1}
	[967] = "%.1f",  -- Left Forward Flood Light Direction, MIN..MAX {0..1}
	[968] = "%.1f",  -- Left Aft Flood Light Direction, MIN..MAX {0..1}
	[976] = "%.1f",  -- Oxygen Supply Valve, MIN..MAX {0..1}
}
